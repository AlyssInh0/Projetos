...
function PokemonInfo({pokemonName}) {
  ...
  // Criandoo uma única variável de estado, do tipo objeto, com a mesma funcionalidade de três variáveis de estado avulsas
  ...
  }) // Vetor de dependências vazio para executar a cada atualização
